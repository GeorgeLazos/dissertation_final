"""config/agents/reits.py — everything the REIT agent trains with.

Self-contained: edit here, train with
    python -m portfolio.models.train --sleeve reits

The sleeve's relative-value structure needs capacity: at hidden 64 the
walk-forward arms plateau near the promotion bar, at hidden 128 (and at
three layers) they clear it — the signal lives in feature interactions
a smaller net cannot compose from the 74 inputs.
"""
